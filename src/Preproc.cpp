...
// and 'p2q2' intersect. 
bool Intersect(Point p1, Point q1, Point p2, Point q2) //True if p and q intersect else false
{ 
...
void InsidePoly(Box *grid, Polygon *ListPolygons, int N_Polygons, int numberofBox) 
{
    for(int i=0; i<numberofBox; i++)
    {
        ...
        {
            //Check if the Polygon is inside another polygon
